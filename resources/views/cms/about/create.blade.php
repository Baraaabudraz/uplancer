...
@section('content')
    ...
    <div class="card">
        ...
        <!--end::Card header-->
        <!--begin::Form-->
        <form id="kt_project_settings_form" action="{{route('store-settings')}}" method="POST" enctype="multipart/form-data" class="form fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate">
            @csrf
            <!--begin::Card body-->
