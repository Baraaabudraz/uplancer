...
@section('title', trans('dashboard_trans.Projects'))
    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-place="true" data-kt-place-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">{{trans('dashboard_trans.Projects')}}</h1>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a href="{{route('projects.index')}}" class="text-muted text-hover-primary">{{trans('dashboard_trans.Projects')}}</a>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-dark">{{trans('dashboard_trans.All projects')}}</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
    ...
    <div class="card mb-5 mb-xl-8">
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bolder fs-3 mb-1">{{trans('dashboard_trans.All projects')}}</span>
            </h3>
            <div class="card-toolbar">
                <a href="{{route('projects.create')}}" class="btn btn-sm btn-light-primary">
                    <!--begin::Svg Icon | path: icons/duotone/Communication/Add-user.svg-->
                    <span class="svg-icon svg-icon-2">
											<i class="fa fa-plus"></i>
											</span>
                    <!--end::Svg Icon-->  {{trans('dashboard_trans.Add new project')}}</a>
            </div>
        </div>
        <!--end::Header-->
        <!--begin::Body-->
        <div class="card-body py-3">
            ...
            <div class="table-responsive">
                <!--begin::Table-->
                <table class="table table-striped table-row-bordered gy-5 gs-7 border rounded" id="kt_cms_projects_table">
                    <thead>
                    <tr class="fw-bolder fs-6 text-gray-800 px-7">
                        <th class="w-10px pe-2">
                            <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                <input class="form-check-input" type="checkbox" data-kt-check="true" data-kt-check-target="#kt_cms_projects_table .form-check-input" value="1" />
                            </div>
                        </th>
                        <th>{{trans('dashboard_trans.Projects')}}</th>
...
{{--                                <a href="#"  onclick="confirmDelete (this, '{{ $project->id }}')"--}}
...
@section('scripts')
    ...
    <script src="{{asset('assets/js/cms/projects/projects.js')}}"></script>
