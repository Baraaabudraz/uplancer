                            ...
                            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                                ...
                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
									<span class="menu-link">
										...
										<span class="menu-title">{{trans('dashboard_trans.Team Members')}}</span>
                                        <span class="menu-arrow"></span>
									</span>
                                    <div class="menu-sub menu-sub-accordion">
                                        <div class="menu-item">
                                            <a class="menu-link" href="{{route('members.index')}}">
                                                ...
                                                <span class="menu-title">{{trans('dashboard_trans.All Members')}}</span>
                                            </a>
                                        </div>
                                        <div class="menu-item">
                                            <a class="menu-link" href="{{route('members.create')}}">
                                                ...
                                                <span class="menu-title">{{trans('dashboard_trans.Add new member')}}</span>
                                            </a>
                                        </div>
                                    </div>
                                </div>
