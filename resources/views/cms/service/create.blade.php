                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 d-flex flex-column mb-8 fv-row">
                                        ...
                                        <div class="col-md-6 d-flex flex-column mb-8 fv-row">
                                            ...
                                            <input class="form-control form-control-solid" placeholder="{{trans('dashboard_trans.Enter the name of the icon')}}" name="icon" value="{{old('icon')}}" />
                                            @error('icon')
                                            <span class="text-danger">{{$message}}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div  class="col-md-6 ">
                                            <!--begin::Label-->
                                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                                <span>{{trans('dashboard_trans.Image')}}</span>
