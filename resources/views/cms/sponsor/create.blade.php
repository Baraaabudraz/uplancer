...
@section('title')
    {{trans('dashboard_trans.Add new sponsor')}}
@endsection
@section('content')
    <!--begin::Toolbar-->
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-place="true" data-kt-place-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">{{trans('dashboard_trans.Add new sponsor')}}</h1>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-dark">{{trans('dashboard_trans.Add new sponsor')}}</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
            ...
            <div class="card card-xl-stretch mb-5 mb-xl-8">
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="mb-13 text-center">
                        <!--begin::Title-->
                        <h1 class="mb-3">{{trans('dashboard_trans.Add new sponsor')}}</h1>
                        <!--end::Title-->
                        <!--begin::Description-->
                    ...
                    <form method="POST" action="{{route('sponsors.store')}}" enctype="multipart/form-data" class="w-100 position-relative mb-3">
                        @csrf
                        <div class="row">
                            <div class="col-md-12 mb-10" style="border:1px ">
                                <div class="row">
                                        ...
                                        <div class="col-md-6 d-flex flex-column mb-8 fv-row">
                                            ...
                                            <input class="form-control form-control-solid" name="name" placeholder=" " value="{{old('name')}}" />
                                            @error('name')
