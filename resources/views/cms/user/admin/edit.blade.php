...
@section('title')
    {{trans('dashboard_trans.Edit admin')}}
@endsection
@section('content')
    <!--begin::Toolbar-->
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-place="true" data-kt-place-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">{{trans('dashboard_trans.Edit admin')}}</h1>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-dark">{{trans('dashboard_trans.Edit admin')}}</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
            ...
            <div class="card card-xl-stretch mb-5 mb-xl-8">
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="mb-13 text-center">
                        <!--begin::Title-->
                        <h1 class="mb-3">{{trans('dashboard_trans.Edit admin')}}</h1>
                        <!--end::Title-->
                        <!--begin::Description-->
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="col-md-12 d-flex flex-column mb-8 fv-row">
                                            ...
                                            <input type="tel" name="mobile_number" value="{{$admins->mobile_number}}"
                                        ...
                                        <div class="col-md-12 d-flex flex-column mb-8 fv-row">
                                            ...
                                            <input type="text" name="designation" value="{{$admins->designation}}"
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="col-md-12 d-flex flex-column mb-8 fv-row">
                                            ...
                                            <input type="email" value="{{$admins->email}}" name="email"
                                        ...
                                        <div class="col-md-12 d-flex flex-column mb-8 fv-row">
                                            ...
                                            <select class="form-select" name="role_id" required="">
                                                ...
                                                @foreach($roles as $role)
                                                    <option value="{{$role->id}}" @if($admins->role_id == $role->id) selected @endif>{{$role->name}}</option>
                                                @endforeach
                                            </select>
                                            @error('role_id')
                                            <span class="text-danger" role="alert">{{ $message }}</span>
                                        ...
                                        <div class="col-md-6 d-flex flex-column mb-8 fv-row">
                                            ...
                                            <div class="col-lg-8 d-flex align-items-center">
                                                <div class="form-check form-check-solid form-switch form-check-custom fv-row">
                                                    <input class="form-check-input w-45px h-30px" name="status" @if($admins->status == 'Active') checked @endif type="checkbox" id="status_1" checked="checked">
