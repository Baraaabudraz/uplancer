...
@section('page-vendors')
    ...
    <script src="{{asset('cms/assets/plugins/custom/fullcalendar/fullcalendar.bundle.js')}}"
            type="text/javascript"></script>
    <script src="//maps.google.com/maps/api/js?key=AIzaSyBTGnKT7dt597vo9QgeQ7BFhvSRP4eiMSM"
            type="text/javascript"></script>
    <script src="{{asset('cms/assets/plugins/custom/gmaps/gmaps.js')}}" type="text/javascript"></script>
...
@section('page-scripts')
    ...
    <script src="{{asset('cms/assets/js/pages/dashboard.js')}}" type="text/javascript"></script>
