...
@section('content')
    ...
    <div class="card">
        ...
        <!--end::Card header-->
        <!--begin::Form-->
        <form id="kt_project_settings_form" action="{{route('settings.store')}}" method="POST" enctype="multipart/form-data" class="form fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate">
            @csrf
            <!--begin::Card body-->
            <div class="card-body p-9">
                ...
                <div class="row mb-8">
                    ...
                    <div class="col-xl-9 fv-row fv-plugins-icon-container">
                        <input type="text" class="form-control form-control-solid" name="name" value="{{old('name')}}" placeholder="{{trans('dashboard_trans.Website Name')}}">
                ...
                <div class="row mb-8">
                    ...
                    <!--begin::Col-->
                    <div class="col-xl-9 fv-row fv-plugins-icon-container">
                        <input type="text" class="form-control form-control-solid" name="company_site" value="{{old('company_site')}}" placeholder="{{trans('dashboard_trans.Company Site')}}">
                        <div class="fv-plugins-message-container invalid-feedback"></div></div>
                </div>
                <!--end::Row-->
                <!--begin::Row-->
                <div class="row mb-8">
                    ...
                    <!--begin::Col-->
                    <div class="col-xl-9 fv-row fv-plugins-icon-container">
                        <input type="tel" class="form-control form-control-solid" value="{{old('phone')}}" name="phone" placeholder="{{trans('dashboard_trans.Phone')}}">
                        <div class="fv-plugins-message-container invalid-feedback"></div></div>
                </div>
                <!--end::Row-->
                <!--begin::Row-->
                <div class="row mb-8">
                    ...
                    <!--begin::Col-->
                    <div class="col-xl-9 fv-row fv-plugins-icon-container">
                        <input type="email" name="email" value="{{old('email')}}" class="form-control form-control-solid" placeholder="{{trans('dashboard_trans.Email')}}">
                        <div class="fv-plugins-message-container invalid-feedback"></div></div>
                    <!--begin::Col-->
                </div>
                <!--end::Row-->
                        ...
                        <div class="card-body border-top p-9">
                            ...
                            <div class="py-2">
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <div class="form-control form-control-solid form-control">
                                            <input class="form-control-input" value="{{old('instagram')}}" type="url" name="instagram" placeholder="Instagram URL">
                                        </div>
                                    </div>
                                </div>
                                <!--end::Item-->
            ...
            <div class="card-footer d-flex justify-content-end py-6 px-9">
                ...
                <button type="submit" class="btn btn-primary" id="kt_project_settings_submit">{{trans('dashboard_trans.Create')}}</button>
            </div>
            <!--end::Card footer-->
