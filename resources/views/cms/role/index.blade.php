...
@section('title')
    {{trans('dashboard_trans.All roles')}}
@endsection
@section('content')
    <!--begin::Toolbar-->
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-place="true" data-kt-place-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">{{trans('dashboard_trans.Roles')}}</h1>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a href="{{route('roles.index')}}" class="text-muted text-hover-primary">{{trans('dashboard_trans.Roles')}}</a>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-dark">{{trans('dashboard_trans.All roles')}}</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
    ...
    <div class="card mb-5 mb-xl-8">
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bolder fs-3 mb-1">{{trans('dashboard_trans.All roles')}}</span>
            </h3>
            <div class="card-toolbar">
                <a href="{{route('roles.create')}}" class="btn btn-sm btn-light-primary">
                    ...
                    <!--end::Svg Icon-->  {{trans('dashboard_trans.Add new role')}}</a>
            </div>
        </div>
        <!--end::Header-->
        <!--begin::Body-->
            ...
            <div class="table-responsive">
                <table class="table table-striped table-row-bordered gy-5 gs-7 border rounded">
                    ...
                    <tr class="fw-bolder fs-6 text-gray-800 px-7">
                            ...
                            <th>{{trans('dashboard_trans.Description')}}</th>
                        ...
                        @if(count($roles)>0)
                            @foreach($roles as $key=>$role)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('roles.edit' , $role->id)}}" class="btn btn-sm btn-light-primary">
                                            <!--begin::Svg Icon | path: icons/duotone/Communication/Add-user.svg-->
                                        ...
                                        <a href="#"  onclick="confirmDelete (this, '{{ $role->id }}')"
