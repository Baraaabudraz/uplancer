...
@section('title')
    {{trans('dashboard_trans.Add new role')}}
@endsection
@section('content')
    <!--begin::Toolbar-->
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-place="true" data-kt-place-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">{{trans('dashboard_trans.Add new role')}}</h1>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-dark">{{trans('dashboard_trans.Add new role')}}</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
            ...
            <div class="card card-xl-stretch mb-5 mb-xl-8">
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="mb-13 text-center">
                        <!--begin::Title-->
                        <h1 class="mb-3">{{trans('dashboard_trans.Add new role')}}</h1>
                        <!--end::Title-->
                        <!--begin::Description-->
                        <div
                    ...
                    <form action="{{route('roles.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between mb-5">
                            <h5 class="m-0 font-weight-bold text-primary">{{trans('dashboard_trans.Add new role')}}</h5>
                        </div>
