    ...
    if (null != e) {
        var i = {dropdown: {hoverTimeout: 200, zindex: 105}, accordion: {slideSpeed: 250, expand: !1}},
            r = function () {
                ...
                var t = x(e, "placement");
                t || (t = "right");
                var n = x(e, "flip"), i = n ? n.split(",") : [], r = x(e, "offset"), o = r ? r.split(",") : [];
                return {
                    placement: t,
                    strategy: !0 === x(e, "overflow") ? "absolute" : "fixed",
                    modifiers: [{name: "offset", options: {offset: o}}, {
...
KTSwapper.getInstance = function (e) {
    ...
    KTUtil.throttle(undefined, (function () {
        ...
        if (e && e.length > 0) for (var t = 0, n = e.length; t < n; t++) KTSwapper.getInstance(e[t]).update()
    }), 200)
